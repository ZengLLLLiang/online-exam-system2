let API = {
    ...
    api: {
        ...
        //管理员获取考试记录信息
        getAdminExamRecord: '/admin/getExamRecord',
        //管理员根据考试记录ID查询考试记录信息(包含摄像头照片)
        getAdminExamRecordById: '/admin/getExamRecordById',
        //管理员根据考试记录ID获取摄像头照片URL列表
        getAdminCameraImages: '/admin/getCameraImages',
        //获取所有题库信息
